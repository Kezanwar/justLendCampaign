...
const Header__SVG = () => {
    return (
        <div className='Header__SVG'>
            ...
            >
                <circle cx="471" cy="373" r="373" fill="#f2f2f2"></circle>
                <ellipse cx="148" cy="774" fill="#f2f2f2" rx="148" ry="23.68"></ellipse>
                <ellipse
                    cx="870"
                    cy="736.969"
                    fill="#f2f2f2"
                ...
                <path
                    fill="#ffb9b9"
                    d="M852.787 740.779L891.549 754.261 918.513 755.946 916.828 732.352 861.213 715.904 852.787 740.779z"
                ></path>
                <path
                    fill="#575a89"
                ...
                <path
                    ...
                    opacity="0.2"
                ></path>
                <circle cx="856.157" cy="420.572" r="38.762" fill="#ffb9b9"></circle>
                <path
                    fill="#4de6ab"
                ...
                <path
                    fill="#3f3d56"
                    d="M583.431 254.891L583.905 256.836 574.322 259.16 577.341 268.549 575.435 269.16 571.76 257.724 583.431 254.891z"
                ></path>
                <path
                    fill="#4de6ab"
                ...
                ></path>
                <circle cx="162.456" cy="146.346" r="38.889" fill="#9f616a"></circle>
                <path
                    fill="#9f616a"
                ...
                <path
                    fill="#2f2e41"
                    d="M265.768 279.254H300.768V344.478H265.768z"
                    transform="rotate(-22.438 129.054 413.587)"
                ></path>
                <ellipse
                    cx="280.75"
                    cy="304.458"
                ...
                ></path>
                <ellipse cx="482" cy="183" fill="#4de6ab" rx="17" ry="9"></ellipse>
                <path
                    fill="none"
                    stroke="#3f3d56"
                    strokeMiterlimit="10"
                ...
                <path
                    fill="#3f3d56"
                    d="M290.708 224.459L292.617 225.063 289.633 234.462 299.227 236.751 298.76 238.698 287.077 235.907 290.708 224.459z"
                ></path>
            </svg>
        </div>
    )
